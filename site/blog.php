...
?>
  <main id="content" role="main" class="main md-flex flex-wrap items-start">
    <section class="commerce-blog-wrapper col-12 md-col-8 px2 pt2 pb3 md-px4 md-pt1 md-pb3">
      <h1 class="xs-hide sm-hide md-commerce-header h3 md-py2 md-mb4">Статьи и новости</h1>
        <?PHP 
        // Новости и статьи 
        ...
        ?>
        <article>
          <amp-img class="mb3" src="img/e-commerce/blog-narrow-01.png" srcset="img/e-commerce/blog-narrow-01.png 750w,img/e-commerce/blog-wide-01.png 1280w" width="750" height="427" layout="responsive" alt="No sleep &#39;til Brooklyn" noloading="">
        <div placeholder="" class="commerce-loader"></div>  </amp-img>
          <div class="mb3 md-mx0">
            <h2 class="h3"><?PHP echo $article['name']; ?></h2>
            <time datetime="2017-03-31T00:00" class="block mb2"><?PHP echo $article['data']; ?></time>
            <p class="mb2"><?PHP echo $article['description']; ?></p>
    ...
    <aside class="commerce-blog-sidebar commerce-side-panel xs-hide sm-hide md-col-4 md-px4 md-pt6">
      <h1 class="h5 md-pb2">Блог Новостей Магазина</h1>
      <p class="mb2">Мы всегда публикуем статьи работы нашего товара</p>
      <h3 class="h7 block pt3">Подписывайтесь на нас</h3>
