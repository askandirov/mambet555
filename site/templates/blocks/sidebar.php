  ...
  <nav class="ampstart-sidebar-nav ampstart-nav">
    <ul class="list-reset m0 p0 ampstart-label">
        <li>
          ...
          <amp-img src="img/logo.svg"  width="136" height="57" layout="responsive" class="ampstart-sidebar-nav-image inline-block mb4" alt="Company logo" noloading="">
            <div placeholder="" class="commerce-loader"></div>
          </amp-img>
          </a>
        </li>
          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="products.php">Товары</a></li>
          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="blog.php">Блог</a></li>
