  ...
  <nav class="mx-auto md-mb0 md-pt5 md-pb5">
    <ul class="list-reset flex flex-wrap my0 md-pl4 md-pr4 md-mxn4">
      <li class="pt3 md-pt0 md-px4 col-12 md-col-3 lg-col-2">
          <h2 class="commerce-footer-header h7 pb2">О нас</h2>
      ...
      <li class="pt3 md-pt0 md-px4 col-12 md-col-3 lg-col-2">
          <h2 class="commerce-footer-header h7 pb2">Контакты</h2>
          <ul class="list-reset pb3 md-mx0">
              <li>
                <a class="text-decoration-none" href="tel:+77775801616">+7 777 580 16 16</a>
              </li>
              <li>
                <a class="text-decoration-none" href="mailto:zakaz@foodpro.kz">zakaz@foodpro.kz</a>
              </li>
              <li>
...
<ul class="ampstart-social-follow list-reset flex justify-around items-center flex-wrap m0 mb4">
    ...
    <li>
      ...
      <li class="flex-auto right-align">
        <amp-img src="img/logo-white.svg" width="136" height="57" layout="fixed" class="my0 mx-auto mr5" alt=""></amp-img>
      </li>
    </ul>
  </nav>
</footer>
