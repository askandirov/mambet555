...
<!-- End Radio -->
    ...
    <div class="col-12 md-col-7 pt2 pb3 md-px4 md-pt1 md-pb7">
      ...
      <amp-list class="mx1 md-mxn1" [src]="'templates/api/' + products.filter + '-' + products.category + '-products.json'" src="templates/api/high-low-all-products.json" height="1000" width="300" layout="responsive">
